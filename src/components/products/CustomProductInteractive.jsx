...
export default function CustomProductInteractive({ productID, product, customInputs, dressTypes, reviewStats, dynamicSections }) {
    ...
    const [selectedDressType, setSelectedDressType] = useState(dressTypes?.length === 1 ? dressTypes[0] : null);
    ...
    // ── Handlers ───────────────────────────────────────────────────────────
    const handleIncrement = () => { if (count < (product.stock || 100)) setCount(p => p + 1); };
    ...
    const validate = () => {
        if (dressTypes && dressTypes.length > 0 && !selectedDressType) {
                ...
                <div className="md:py-[30px] max-w-[1200px] mx-auto">
                    <div className="pdp-top-grid">
                        ...
                        <div style={{ padding: "0 10px" }}>
                            ...
                            {dressTypes && dressTypes.length > 0 && (
