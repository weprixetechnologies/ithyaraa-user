...
const MyProfile = () => {
    const [profile, setProfile] = useState({
        fullName: '',
        emailID: 'ronitsarkar.dev@gmail.com',
        phonenumber: '7439398783',
        uid: 'UX74LLI297',
        username: 'ronit_sarkar_01'
    });
        ...
        <div>
            ...
            <div className="flex justify-between mb-3 py-2">
                <div className="flex flex-col">
                    ...
                    <p className='text-xs text-secondary-text-deep'>Update your photo and personal details here</p>
                </div>
                <div className="flex gap-2">
                    <button className='px-3 py-2 bg-transparent border-gray-200 border rounded-lg'>Cancel</button>
                    <button className='px-3 py-2 bg-primary-yellow rounded-lg'>Save Changes</button>
                </div>
            </div>
            ...
            <div className="flex justify-between mb-3 pt-2">
                ...
                <div className="flex gap-2 shrink">
                    <input
                        ...
                        readOnly
                        className='bg-gray-200 border-gray-200 border text-xs px-4 rounded-lg min-h-[35px] shrink'
                        placeholder='Phone Number'
                    />
                </div>
            </div>

            {/* Username + UID (read-only) */}
            ...
            <div className="flex justify-between mb-3 py-2">
                <div className="flex flex-col">
                    ...
                    <p className='text-xs text-secondary-text-deep'>The photo will be displayed on your profile</p>
                </div>
                <div className="flex gap-2">
