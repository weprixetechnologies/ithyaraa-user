                        ...
                        <div key={index}>
                            ...
                            >
                                ...
                                <div className="flex gap-2 pl-7">
                                    <div className="block">
                                        <div className="relative aspect-[2/3] md:w-[120px] md:min-w-[120px] w-[100px] min-w-[100px]">
                                    ...
                                    i.comboItems.map((p, index) => (
                                        <div className="border border-gray-200 pr-5 py-3 pl-3 rounded-lg relative mt-2" key={index}>
                                            ...
                                            <div className="flex gap-2 ">
                                                <div className="block">
                                                    <div className="relative aspect-[2/3] md:w-[80px] md:min-w-[80px] w-[80px] min-w-[80px]">
