...
const SignUpAction = () => {
    ...
    const sendOtp = async () => {
        setLoading(true);
        try {
            const res = await fetch('https://backend.ithyaraa.com/api/user/send-otp', {
                method: 'POST',
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            // verify OTP
            const verifyRes = await fetch('https://backend.ithyaraa.com/api/user/verify-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            // create user
            const createRes = await fetch('https://backend.ithyaraa.com/api/user/create-user', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    password,
                    ...
                    referCode,
                    phoneVerified: true // Mark phone as verified since OTP was verified
                })
            });
