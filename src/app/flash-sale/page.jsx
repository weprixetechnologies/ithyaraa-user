                                ...
                                <div className="flex bg-gray-50 p-1 rounded-lg border border-gray-100">
                                    {[12, 24, 48].map(n => (
                                        <button
                                            ...
                                            className={`px-3 py-1 text-[10px] md:text-xs font-bold rounded-md transition-all ${limit === n ? 'bg-white text-red-600 shadow-sm ring-1 ring-black/5' : 'text-gray-500 hover:text-gray-800'
                                                }`}
                                        >
                                            {n}
                                        </button>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                                {Array.from({ length: 12 }).map((_, i) => (
                                    <div key={i} className="space-y-3">
                                        <div className="aspect-[2/3] bg-gray-200 rounded-2xl animate-pulse" />
