...
const ProductDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                const res = await axios.get(`https://72.60.219.181:8800/api/products/details/${productID}`);
    ...
    useEffect(() => {
        ...
        const fetchReviewStats = async () => {
            try {
                ...
                const res = await axios.get(`https://72.60.219.181:8800/api/reviews/product/${productID}/stats`);
                if (res.data.success) {
